...
public class DriveConstants {
        ...
        // gearing
        private static final double kSteerGearRatio = 150.0 / 7.0; // Source: MK4i swerve module
                                                                   // page
        ...
        public static class Real {
                ...
                public static final Slot0Configs STEER_GAINS = new Slot0Configs().withKP(80)
                                .withKI(10).withKD(0.5).withKS(0.1).withKV(1.91).withKA(0)
                ...
                public static final Slot0Configs DRIVE_GAINS = new Slot0Configs()
                                ...
                                .withKI(0 * METERS_TO_ROTATIONS).withKD(0 * METERS_TO_ROTATIONS)
                                .withKS(0.19598).withKV(0.77537)
        ...
        public static final Distance DRIVE_BASE_RADIUS = Meters.of(Math.max(
                        Math.max(Math.hypot(DriveConstants.FrontLeft.LocationX,
                                        DriveConstants.FrontRight.LocationY),
                                        Math.hypot(DriveConstants.FrontRight.LocationX,
                                                        DriveConstants.FrontRight.LocationY)),
                        Math.max(Math.hypot(DriveConstants.BackLeft.LocationX,
                                        DriveConstants.BackLeft.LocationY),
                                        Math.hypot(DriveConstants.BackRight.LocationX,
                                                        DriveConstants.BackRight.LocationY))));

        public static final AngularVelocity MAX_ANGULAR_VELOCITY = RadiansPerSecond
                        .of(kSpeedAt12Volts.in(MetersPerSecond) / DRIVE_BASE_RADIUS.in(Meters));
