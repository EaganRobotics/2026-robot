...
package frc.robot.robot26.commands;
...
public class DriveCommands {
        ...
        private static final Translation2d BLUE_REEF_CENTER = new Translation2d(
                        Inches.of(REEF_CENTER_X_INCHES), Inches.of(REEF_CENTER_Y_INCHES));
        ...
        public static Pose2d[] makeReefPositions(Distance reefOffset) {
                Transform2d REEF_BRANCH_TO_ROBOT =
                                new Transform2d(Inches.of(-INCHES_FROM_REEF).minus(reefOffset),
                                                Inches.zero(), Rotation2d.kZero);
                return new Pose2d[] {
                                new Pose2d(BLUE_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(-20.738000), Inches.of(6.482000))),
                                                Rotation2d.kZero).transformBy(REEF_BRANCH_TO_ROBOT),
                                new Pose2d(BLUE_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(-20.738000), Inches.of(-6.482000))),
                                                Rotation2d.kZero).transformBy(REEF_BRANCH_TO_ROBOT),
                                new Pose2d(BLUE_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(-15.982577), Inches.of(-14.718635))),
                                                Rotation2d.fromDegrees(60))
                                                                .transformBy(REEF_BRANCH_TO_ROBOT),
                                new Pose2d(BLUE_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(-4.755423), Inches.of(-21.200635))),
                                                Rotation2d.fromDegrees(60))
                                                                .transformBy(REEF_BRANCH_TO_ROBOT),
                                new Pose2d(BLUE_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(4.755423), Inches.of(-21.200635))),
                                ...
                                new Pose2d(RED_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(20.738000), Inches.of(-6.482000))),
                                                Rotation2d.fromDegrees(180))
                                                                .transformBy(REEF_BRANCH_TO_ROBOT),
                                new Pose2d(RED_REEF_CENTER.plus(new Translation2d(
                                ...
                                new Pose2d(RED_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(15.982577), Inches.of(-14.718635))),
                                                Rotation2d.fromDegrees(120)).transformBy(
                                                                REEF_BRANCH_TO_ROBOT),};
        }
        ...
        public static Pose2d[] makeRightReefPositions(Distance reefOffset) {
                ...
                return new Pose2d[] {
                                ...
                                new Pose2d(RED_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(-15.982577), Inches.of(14.718635))),
                                                Rotation2d.fromDegrees(300)).transformBy(
                                                                REEF_BRANCH_TO_ROBOT),};
        }
        ...
        public static Pose2d[] makeAlgaePositions(Distance algaeOffset) {
                Transform2d FRONT_ALGAE_TO_ROBOT =
                                new Transform2d(Inches.of(-INCHES_FROM_ALGAE).minus(algaeOffset),
                                                Inches.zero(), Rotation2d.kZero);
                ...
                return new Pose2d[] {
                                new Pose2d(BLUE_REEF_CENTER, Rotation2d.kZero)
                                                .transformBy(FRONT_ALGAE_TO_ROBOT),
                                ...
                                new Pose2d(RED_REEF_CENTER, Rotation2d.kZero)
                                                .transformBy(FRONT_ALGAE_TO_ROBOT),
                ...
                return new Pose2d[] {
                                ...
                                new Pose2d(Inches.of(Right_Loading_Station_X + 5.5),
                                                ...
                                                Rotation2d.fromDegrees(55))
                                                                .plus(new Transform2d(sourceOffset,
                                                                                Inches.of(0),
                                                                                Rotation2d.kZero)),
                                new Pose2d(Inches.of(Left_Loading_Station_X - 1.5),
                                                ...
                                                Rotation2d.fromDegrees(-55))
                                                                .plus(new Transform2d(sourceOffset,
                                                                                Inches.of(0),
                                                                                Rotation2d.kZero))
                                                                .plus(new Transform2d(Inches.of(2)
                                                                                .plus(sourceOffset),
                                                                                Inches.of(-14),
                                                                                Rotation2d.kZero)),
                                new Pose2d(Inches.of(Right_Loading_Station_X + 5.5 + 623.825 - 8 - 6
                                                - 2),
                                                Inches.of(Right_Loading_Station_Y + 5.5 + 3 + 6
                                                                + 2),
        ...
        public static Pose2d[] makeBargePositions(Distance bargeOffset) {
                ...
                return new Pose2d[] {
                                new Pose2d(Inches.of(BLUE_BARGE_X), Inches.of(LEFT_BLUE_BARGE_Y),
                                                Rotation2d.kZero),
                                ...
                                new Pose2d(Inches.of(RED_BARGE_X), Inches.of(LEFT_RED_BARGE_Y),
                                                Rotation2d.kZero),
                                new Pose2d(Inches.of(RED_BARGE_X), Inches.of(MIDDLE_RED_BARGE_Y),
                                                Rotation2d.kZero),
        ...
        public static Pose2d[] makeAutoPositions(Distance autoOffset) {
                Transform2d REEF_BRANCH_TO_ROBOT =
                                new Transform2d(Inches.of(-INCHES_FROM_REEF).minus(autoOffset),
                                                Inches.zero(), Rotation2d.kZero);
                return new Pose2d[] {
                                new Pose2d(BLUE_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(-4.755423), Inches.of(-21.200635))),
                                ...
                                new Pose2d(RED_REEF_CENTER.plus(new Translation2d(
                                                Inches.of(4.755423), Inches.of(21.200635))),
                                                Rotation2d.fromDegrees(240)).transformBy(
                                                                REEF_BRANCH_TO_ROBOT),};
        }
        ...
        private static final ProfiledPIDController xController =
                        new ProfiledPIDController(0, 0, 0, new TrapezoidProfile.Constraints(
                                        POSITION_MAX_VELOCITY, POSITION_MAX_ACCELERATION));
        ...
        private static Translation2d getLinearVelocityFromJoysticks(double x, double y) {
                ...
                return new Pose2d(new Translation2d(), linearDirection).transformBy(
        ...
        // double interpolateTime =
        // drive.getPose().getTranslation().getDistance(outer.getTranslation()) > 1.5 ? 1.5
        // : 0.75;
        ...
        // private static Optional<Pose2dSequence> getClosestReefPosition(Drive drive, Distance
        // radius)
        // {
        ...
        // private static Optional<Pose2dSequence> getClosestLeftPosition(Drive drive, Distance
        // radius)
        // {
        // Optional<Pose2dSequence> desiredPose = Optional.empty();
        // Distance minDistance = Meters.of(1000000);
        ...
        // private static Optional<Pose2dSequence> getClosestRightPosition(Drive drive, Distance
        // radius)
        // {
        // Optional<Pose2dSequence> desiredPose = Optional.empty();
        // Distance minDistance = Meters.of(1000000);
        ...
        // private static Optional<Pose2dSequence> getClosestAlgaePosition(Drive drive, Distance
        // radius)
        // {
        // Optional<Pose2dSequence> desiredPose = Optional.empty();
        // Distance minDistance = Meters.of(1000000);
