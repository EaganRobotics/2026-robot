...
public class ShooterDistanceTable {
  ...
  static {
    ...
    table.put(15, new ShooterSetpoint(RPM.of(575), RPM.of(3000), Degree.of(20)));
    table.put(16.5, new ShooterSetpoint(RPM.of(600), RPM.of(3000), Degree.of(20)));
    table.put(18, new ShooterSetpoint(RPM.of(620), RPM.of(3000), Degree.of(20)));
    table.put(19.5, new ShooterSetpoint(RPM.of(627), RPM.of(3000), Degree.of(20)));
  }
