...
public class ShooterDistanceTable {
  ...
  static {
    ...
    // 5 ft options
    table.put(5, new ShooterSetpoint(RPM.of(2435), RPM.of(3000), Degree.of(0)));
    ...
    // 6.44 ft options
    table.put(6.44, new ShooterSetpoint(RPM.of(2600), RPM.of(3000), Degree.of(9.25)));
    ...
    // 7.89 ft options
    table.put(7.89, new ShooterSetpoint(RPM.of(2481), RPM.of(3000), Degree.of(11)));
    ...
    // 9.33 ft options
    table.put(9.33, new ShooterSetpoint(RPM.of(2480), RPM.of(3000), Degree.of(12.75)));
    ...
    // 10.78 ft options
    table.put(10.78, new ShooterSetpoint(RPM.of(2657), RPM.of(3000), Degree.of(18.5)));
    ...
    // Degree.of(18.25)));
    // 12.22 ft options
    table.put(12.22, new ShooterSetpoint(RPM.of(2832), RPM.of(3000), Degree.of(23.25)));
    ...
    // 13.67 ft options
    table.put(13.67, new ShooterSetpoint(RPM.of(2925), RPM.of(3000), Degree.of(25.5)));
