...
import frc.lib.simulation.SimConstants.Mode;
import frc.robot26.generated.TunerConstants;
import frc.robot26.util.LocalADStarAK;
...
public class Drive extends SubsystemBase {
  ...
  private Consumer<Pose2d> setSimulatedPoseCallback;
  ...
  public void periodic() {
    ...
    Logger.recordOutput("Drive/Geofence/Inside", DriveGeofence.isInside(getPose()));
  }
  ...
  public void runVelocity(ChassisSpeeds speeds) {
    speeds = DriveGeofence.constrain(getPose(), speeds);
  ...
  public void setPose(Pose2d pose) {
    Logger.recordOutput("Pose/SetPoseLastCalledPosition", pose);
