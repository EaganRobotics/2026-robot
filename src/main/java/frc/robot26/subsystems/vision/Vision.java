...
import static frc.robot26.subsystems.vision.VisionConstants.*;
...
import frc.robot26.subsystems.vision.VisionIO.PoseObservationType;
...
public class Vision extends SubsystemBase {
  ...
  public void periodic() {
      ...
      for (var observation : inputs[cameraIndex].poseObservations) {
        ...
        boolean rejectPose =
            observation.tagCount() == 0 // Must have at least one tag
                || (observation.tagCount() == 1 && observation.ambiguity() > maxAmbiguity) // Cannot
                // be
                // high
                // ambiguity
    ...
    hasSeenAprilTag = !allRobotPosesAccepted.isEmpty();
  }
