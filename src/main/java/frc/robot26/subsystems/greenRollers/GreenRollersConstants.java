...
public class GreenRollersConstants {
  ...
  public static final LoggedTunablePIDs greenRollersPIDs =
      new LoggedTunablePIDs("GreenRollers", 0.2, 0.0, 0.0); // TODO: change
  public static final LoggedTunableNumber greenRollersSpeed =
      new LoggedTunableNumber("Tuning/GreenRollersSpeed", 3000);

  public static final class Real {
    public static final int greenRollersMotorID = 20;
  }
